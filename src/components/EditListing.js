...
function EditListing() {
    ...
    const fetchListing = async () => {
      try {
        ...
        setFormData({
          ...
          first_registration_month: car.first_registration_month,
          mileage: car.mileage,
          doors: car.doors,
          ...
          headlight_type: car.headlight_type,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(`http://localhost:3030/api/cars/edit/${id}`, data, {
        headers: {
      ...
      alert('Nepodařilo se upravit inzerát.');
    }
  };
  ...
  return (
    <>
      ...
      <div className="homepage">
        ...
        <h2 id="create-listing-heading">Upravit inzerát</h2>
        ...
        <form className="create-listing-form" onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <input type="number" name="first_registration_year" value={formData.first_registration_year} onChange={handleInputChange} required />
          </div>
          ...
          <div className="form-group">
            ...
            <input type="number" name="power_kw" value={formData.power_kw} onChange={handleInputChange} required />
          </div>

          <div className="form-group">
            <label>Barva exteriéru:</label>
          ...
          <div className="form-group">
            ...
            <select name="interior_material" value={formData.interior_material} onChange={handleInputChange} required>
              ...
              <option value="Part Leather">Částečná kůže</option>
          ...
          <div className="form-group">
            <label>Obrázky (nahradí stávající):</label>
